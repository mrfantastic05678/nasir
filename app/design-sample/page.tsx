...
// We simulate the new color palette via Tailwind arbitrary values here
// so we don't pollute the global tailwind.config.ts until the user
// approves the look and feel.

const TechLuxuryTheme = {
  bgBase: "bg-[#05060A]", // Deep Onyx
  bgCard: "bg-[#0E101A]", // Slightly lighter card
  accentGradient: "bg-gradient-to-r from-[#6366f1] to-[#38bdf8]", // Electric Indigo to Cyan
  accentGradientText: "text-transparent bg-clip-text bg-gradient-to-r from-[#6366f1] to-[#38bdf8]",
  accentText: "text-[#38bdf8]",
  borderGlow: "border-[#6366f1]/30",
};
...
export default function DesignSample() {
  ...
  return (
    <div
      className={`min-h-screen ${TechLuxuryTheme.bgBase} text-white font-sans selection:bg-[#6366f1]/30 relative overflow-hidden`}
      style={{
    ...
    >
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[#6366f1] rounded-full blur-[150px] opacity-20 pointer-events-none" />
      <div className="absolute top-[40%] right-[-10%] w-[30%] h-[50%] bg-[#38bdf8] rounded-full blur-[150px] opacity-10 pointer-events-none" />

      {/* Hero Section styled with the new colors but old layout/components */}
        ...
        <HeroHighlight>
          <div className="max-w-7xl mx-auto flex px-5 pt-40 py-10 md:flex-row flex-col items-center min-h-screen">
            <div className="sm:entrance-left lg:flex-grow md:w-1/2 lg:pr-16 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center lg:w-3/5">
              ...
              {/* Available Badge */}
              <div className="mb-4">
                <span className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-medium text-gray-300 border border-white/10 ${TechLuxuryTheme.bgCard} shadow-xl backdrop-blur-md`}>
              ...
              <div className="flex justify-center gap-4 flex-wrap">
                <Link href="#contact" className="scroll-smooth duration-300">
                  <button className={`group relative overflow-hidden flex items-center text-white px-8 py-3.5 rounded-full font-medium text-sm tracking-wide ${TechLuxuryTheme.accentGradient}`}>
                ...
                <Link href="#projects" className="scroll-smooth duration-300">
                  <button className="group flex items-center text-white bg-transparent border border-white/20 hover:border-white/50 py-3.5 rounded-full font-medium text-sm px-8 transition-all duration-300">
                    View Projects
                ...
                <div>
                  ...
                  <div className="container flex flex-row items-center gap-3 justify-center md:justify-start flex-wrap">
                    <AnimatedTooltip tooltipTitle="Next.js" tooltipDescription="SaaS & Full-Stack">
                      <div className={`shadow-xl shadow-black/50 opacity-80 hover:opacity-100 rounded-lg ${TechLuxuryTheme.bgCard} border ${TechLuxuryTheme.borderGlow} p-3 text-2xl text-gray-300 hover:text-white transition-all`}>
                        <RiNextjsLine />
                      </div>
                    </AnimatedTooltip>
